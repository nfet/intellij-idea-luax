...
class CsvToLuaAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val rendered = renderTemplate(templateText, args)
    ...
    private fun renderTemplate(templateText: String, args: String): String {
        return try {
            FileTemplateUtil.mergeTemplate(mapOf("args" to args), templateText, false)
        } catch (_: Exception) {
            templateText.replace("\${args}", args)
        }
    }
